...
export default function Login() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setLoading(false);
      toast.error(
        "Apologies, unable to fulfill your request now. Please try again later."
      );
    }
  };
    ...
    <>
      <div className="row authentication mx-0">
            ...
            <div className="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
              <div className="p-5">
                <div className="text-center mb-5">
                  <img
                    src="/assets/images/1658930039795.wenp"
                    alt="logo"
                    className="authentication-brand desktop-logo mx-auto mb-2 w-50 h-50"
                  />
                  <h5 className="fw-semibold mb-2">Sign In</h5>
                  <p className="mb-3 text-muted op-7">
                    One step away from your work. Let's Start!
                  </p>
                </div>
                  ...
                  <div className="row gy-3">
                    ...
                    <div className="col-xl-12 mt-0">
                      ...
                      <input
                        ...
                        id="email"
                        value={"camperdark96@gmail.com"}
                        placeholder="Email"
                        {...register("email")}
                        maxLength={42}
                      />
                      {errors.email?.message != undefined && (
                        <span className="error mt-2 text-danger d-block">
                    ...
                    <div className="col-xl-12 mb-3">
                      ...
                      <div className="mt-2">
                        <div className="form-check d-flex justify-content-between">
                          ...
                          <div className="">
                            <label
                              className="form-check-label text-muted fw-normal cursor-pointer"
                              onClick={() => {
        ...
        <div className=" col-xxl-5 col-xl-5 col-lg-12 ">
          ...
          <img src="https://images.unsplash.com/photo-1635805737707-575885ab0820?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c3BpZGVybWFufGVufDB8fDB8fHww" alt="logo" className="w-75" />
          </div>  
        </div> 
      </div>
    </>
